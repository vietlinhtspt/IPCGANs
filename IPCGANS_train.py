...
parser.add_argument('--max_epoches', type=int, help='Number of epoches to run', default=100)
parser.add_argument('--val_interval', type=int, help='Number of steps to validate', default=2500)
parser.add_argument('--save_interval', type=int, help='Number of batches to save model', default=2500)
...
def main():
    ...
    for epoch in range(args.max_epoches):
        for idx, (source_img_227,source_img_128,true_label_img,\
            ...
            samples_tqdm.set_description(format_str % (idx, len(train_loader),running_g_loss,running_d_loss))
